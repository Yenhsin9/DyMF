...
class BadmintonDatasetFORTEST(Dataset):
    def __init__(self, data, used_column, args):
        super(BadmintonDatasetFORTEST).__init__()
        self.player_sequence = []
        self.court_sequence = []
        self.target_sequence = []
        self.adj=[]

        rally_id_grouped = data.groupby('rally').groups
        ...
        for rally_id in rally_id_grouped.values():
            ...
            self.player_sequence.append([player, shot_type, seqence_length, adj, player_A_loc, player_B_loc, mask])
